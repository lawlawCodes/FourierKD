...
class RepPointsHead(AnchorFreeHead):
    ...
    def loss_by_feat(
        ...
        _ = self.get_iouaware_distillation(cls_scores, pts_coordinate_preds_refine, labels_list, label_weights_list, avg_factor_refine)
    ...
    def get_iouaware_distillation(self, cls_score, bbox_pred, labels_list, label_weights_list, avg_factor):
        return cls_score, bbox_pred, labels_list, label_weights_list, avg_factor
